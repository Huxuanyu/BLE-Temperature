...
public class ScanningActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 创建除了uideficefound功能blewrapper空的回调对象  扫描行为
    ...
    private void btDisabled() {
    	Toast.makeText(this, "抱歉，蓝牙必须打开才能工作!", Toast.LENGTH_LONG).show();
        finish();    	
    }
    
    private void bleMissing() {
    	Toast.makeText(this, "软件需要硬件支持，但不可用!", Toast.LENGTH_LONG).show();
        finish();    	
    }
}
